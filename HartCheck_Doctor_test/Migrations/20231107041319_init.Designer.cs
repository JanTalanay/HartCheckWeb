...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.ArchievedRecord", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.AuditLogValue", b =>
                {
                    b.Property<int>("auditLogID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BloodPressure", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BloodPressureThreshold", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BMIType", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BodyMass", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BugReport", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Chat", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Clinic", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Condition", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Consultation", b =>
                {
                    b.Property<int>("consultationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Diagnosis", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.DoctorLicense", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.DoctorSchedule", b =>
                {
                    b.Property<int>("doctorSchedID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.EducationalResource", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.HealthCareClinic", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.HealthCareProfessional", b =>
                {
                    b.Property<int>("doctorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.MedicalCondition", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.MedicalHistory", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Medicine", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Messages", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Patients", b =>
                {
                    b.Property<int>("patientID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.PatientsDoctor", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.PreviousMedication", b =>
                {
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Resource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Users", b =>
                {
                    b.Property<int>("usersID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.WorkOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.ArchievedRecord", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Patients", "patients")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.AuditLog", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Users", "users")
                        .WithMany("auditlog")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.AuditLogValue", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.AuditLog", "auditlog")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BloodPressureThreshold", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.HealthCareProfessional", "doctor")
                        .WithOne("BloodPressureThreshold")
                        .HasForeignKey("HartCheck_Doctor_test.Models.BloodPressureThreshold", "doctorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HartCheck_Doctor_test.Models.Patients", "patients")
                        .WithOne("BloodPressureThreshold")
                        .HasForeignKey("HartCheck_Doctor_test.Models.BloodPressureThreshold", "patientID")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BMIType", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.BodyMass", "BodyMass")
                        .WithOne("BMIType")
                        .HasForeignKey("HartCheck_Doctor_test.Models.BMIType", "BMITypeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BodyMass", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Patients", "patient")
                        .WithMany("BodyMass")
                        .HasForeignKey("patientID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.BugReport", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Users", "User")
                        .WithMany("bugreport")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Chat", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Consultation", "consultations")
                        .WithOne("chat")
                        .HasForeignKey("HartCheck_Doctor_test.Models.Chat", "consultationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Clinic", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.HealthCareClinic", "HealthcareClinic")
                        .WithMany("clinic")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Condition", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Consultation", "consultation")
                        .WithMany("conditions")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.HealthCareProfessional", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.DoctorLicense", "Doctorlicense")
                        .WithOne("doctor")
                        .HasForeignKey("HartCheck_Doctor_test.Models.HealthCareProfessional", "licenseID")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Messages", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Chat", "chat")
                        .WithMany("messages")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.PatientsDoctor", b =>
                {
                    ...
                    b.HasOne("HartCheck_Doctor_test.Models.Patients", "patient")
                        ...
                        .HasForeignKey("HartCheck_Doctor_test.Models.PatientsDoctor", "patientID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.Resource", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Group", "Group")
                        .WithMany("Resources")
            ...
            modelBuilder.Entity("HartCheck_Doctor_test.Models.WorkOrder", b =>
                {
                    b.HasOne("HartCheck_Doctor_test.Models.Resource", "Resource")
                        .WithMany()
